...
public class Test02 {
    ...
    public int getKth(int[] num1, int[] num2, int k) {
        ...
        while (true) {
            ...
            int half = k / 2;
            int newIndex1 = Math.min(index1 + half, num1.length) - 1;
            int newIndex2 = Math.min(index2 + half, num2.length) - 1;
    ...
    public double test01(int[] num1, int[] num2) {
        int allLen = num1.length + num2.length;
        if ((allLen & 1) == 0) {
            return (getKth(num1, num2, allLen / 2) + getKth(num1, num2, allLen / 2 + 1)) / 2.0;
        } else {
            return getKth(num1, num2, allLen / 2 + 1);
        }
    }
